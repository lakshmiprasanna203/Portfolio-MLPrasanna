...
const non_Responsive_Projects = [
  {
    ...
    description : 'Dribbble Mania is a clone of Dribble. Dribble is an California, United States website which discover designs, illustrations, and graphic elements from the worlds best designers.',
...

  {
    ...
    pc_screenshot : 'bank.png',

    mobile_screenshot : null,

    title : 'Mobile Banking ',

    clone : 'clone : Deribble',

    description : 'This App based on online mobile bank app,like credicard apps and banking apps',

    tech_stack : [{skill : 'HTML.png', w : '20px'},{skill : 'CSS.png', w  : '25px'}, { skill : 'Chakra ui.png', w : '25px'}, {skill : 'React.png', w : '25px'},{skill : 'react-router.png', w : '25px'},{skill:"Typescript.png",w:"25px"}],

    netlify : 'https://overwrought-skin-2796.vercel.app/',

    // github : 'https://github.com/Nagaraju0710/overwrought-skin-2796',

    isOnGithub : true

  },
  {
    pc_screenshot : 'gym.png',
    ...
    description : 'This App based on  Gym Center.',
  
    tech_stack : [{skill : 'HTML.png', w : '20px'},{skill : 'CSS.png', w  : '25px'}, { skill : 'Chakra ui.png', w : '25px'}, {skill : 'React.png', w : '25px'},{skill : 'react-router.png', w : '25px'},{skill:"Typescript.png",w:"25px"},{skill:"Mongo db.png",w:"25px"},{skill:"node.png",w:"25px"}],
